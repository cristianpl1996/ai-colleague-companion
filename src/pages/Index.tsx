    ...
    <main className="min-h-screen w-full relative">
      ...
      <div className="relative z-10">
        ...
        <section className="relative min-h-screen flex items-center justify-center px-6 py-20">
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center space-y-8 animate-fade-in parallax-layer" style={{ transform: `translateY(${scrollY * 0.2}px)` }}>
        ...
        {/* Content Sections */}
        <div id="content" ref={sectionsRef} className="max-w-6xl mx-auto px-6 py-20 space-y-12 relative">
            ...
            <div key={index} className="relative">
              ...
              {index % 2 === 0 && index > 0 && (
                <div className="floating-quote" style={{ top: '-40px' }}>
                  "{floatingQuotes[Math.floor(index / 2) % floatingQuotes.length]}"
                </div>
              )}
            ...
            <div className="relative z-10">
              <div className="flex justify-center">
                <div className="w-16 h-16 rounded-full bg-primary/20 flex items-center justify-center glow-icon">
                  <Sparkles className="w-8 h-8 text-primary animate-glow" strokeWidth={1.5} />
                </div>
              </div>
